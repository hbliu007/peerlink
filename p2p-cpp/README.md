...
> [!TIP]
> 详细的部署教程请参考 [SSH 隧道教程](p2p-cpp/docs/tutorials/ssh-tunnel.md) 和 [阿里云部署指南](p2p-cpp/docs/how-to/deploy-aliyun.md)。
...
| 2 | **Protocol** | Signaling Protocol · P2P Protocol · Relay Protocol · Protobuf Messages |
...
| 5 | **Security** | DID Identity · Ed25519 Signing · TLS 1.3 · Signed Envelope |
